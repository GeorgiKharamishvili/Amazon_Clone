...
const ProductFilterPage = () => {
  ...
  const { priceFrom, priceTo, filteredProducts, loading, categories } =
    filterState;
    ...
    <div className="p-[10px] bg-[#fff]">
      <div className="grid grid-cols-12 gap-[10px]">
        <div className="col-span-12 lg:col-span-2">
          <div className="relative filter-div group">
            <button className="text-orange-500 block lg:hidden">Filters</button>
            <div className="hidden lg:flex flex-col absolute lg:relative bg-white w-full filter-box group-hover:flex px-3">
              <ul className="flex flex-col items-start gap-[5px] pointer">
                {categories.map((category) => (
                  ...
                  >
                    <p
                      className={`lg:text-[14px] text-[7px] flex flex-col items-start ${
                        activeCategory === category.id
                          ? "text-orange-500"
                          : "text-[#000]"
                      }`}
              ...
              <div className="flex mb-4 text-[13px] rounded-[5px] mt-[15px] mr-[15px]">
                <input
                  type="text"
                  placeholder="From $"
                  className="border p-2 lg:w-[65px] w-[32px] outline-none"
                  value={priceFrom}
                  onChange={(e) =>
                    setFilterState({
                      ...filterState,
                ...
                />
                <div className="lg:text-[13px] text-[6px] font-bold lg:mt-[6px]">
                  -
                </div>
                <div>
                  <input
                    type="text"
                    placeholder="To $"
                    className="border p-2 w-[65px] outline-none"
                    value={priceTo}
                    onChange={(e) =>
                      setFilterState({
                        ...filterState,
                ...
                <button
                  className="lg:text-[12px] text-[6px]border  lg:p-[8px] p-[2px] lg:ml-[5px]  rounded-sm bg-orange-400 text-white"
              ...
              <div className="gap-[8px] cursor-pointer">
                <p className="font-semibold lg:text-[14px] text-[10px]">
                  Customer Reviews
                </p>
                <div className="pt-[5px] pb-[5px]  flex ">
                  <Rating
                    sx={{ fontSize: { xs: 7, md: 28, lg: 28 } }}
                    className="lg:text-[14px] text-[7px]"
                ...
                <div className="flex text-[14px]">
                  <div className="pt-[5px] pb-[5px]  flex ">
                    <Rating
                      ...
                      readOnly
                    />
                    <p className="lg:text-[14px] text-[4px] lg:ml-[10px]">
                      & up
                    </p>
                  </div>
                </div>
        ...
        <div className="col-span-12 lg:col-span-9 ">
          {loading ? (
            ...
            <div className="grid lg:grid-cols-4 grid-cols-2 place-items-stretch items-stretch ml-6 lg:gap-[8px] gap-[10px] m-0">
